...
// MonkeyTalkAPI.js generated by MonkeyTalk at 2014-12-13 17:08:14 EST
...
//
/**
 * Logging and diagnostics.\n\n MonkeyId would be used as a filepath (absolute or project-relative) instead of '*' when using print function in order to create a file and append the message to it.
 * @class
 * @extends MT.MTObject
...
//
/**
 * Remove the output file if exists. You should use this to delete debug file when starting a test.

 * @returns void 
 */
MT.Debug.prototype.erase = function() {
	return this.app.play(this, "erase", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @class
 * @extends MT.MTObject
 * @param app The MT.Application containing this Web
 * @param monkeyId A monkeyId or ordinal
 */
MT.Web = function(app, monkeyId) {
	MT.MTObject.call(this, app, monkeyId);
	this.componentType = "Web";	
};

MT.Web.prototype = new MT.MTObject;

/**
 * 
 * @param monkeyId the monkeyId (String) or ordinal (int) for which to search. 
 * @returns {MT.Web} the upper-left-most visible Web matching the supplied monkeyId or ordinal
 */
MT.Application.prototype.web = function(monkeyId) {
	if (!monkeyId) {
		monkeyId = "";
	}
	return new MT.Web(this, monkeyId);
};
 ...
 * @param  {String} method the method to call
 * @param  {String} args the args to be supplied to the method

 * @returns void 
 */
MT.Web.prototype.exec = function(method, args) {
	return this.app.play(this, "exec", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @returns String 
 */
MT.Web.prototype.execAndReturn = function(variable, method, args) {
	return this.app.play(this, "execAndReturn", MT.getArgList(arguments), MT.getModifiers(arguments));
};
